...
public class ContactFormServlet extends HttpServlet {
    ...
    // Some other option here is - Use Java 12+ Text Block feature -> """ fhfhghhghghghgh hfhfhghhg """
...
//        sb.append("    <link rel=\"stylesheet\" href=\"https://stackpath.bootstrapcdn.com/bootswatch/4.3.1/cosmo/bootstrap.min.css\" integrity=\"sha384-uhut8PejFZO8994oEgm/ZfAv0mW1/b83nczZzSwElbeILxwkN491YQXsCFTE6+nx\" crossorigin=\"anonymous\">");
        ...
        if(customerName != null) {
            if(customerName.equals("")) {
                sb.append("<input autofocus type=\"text\" class=\"form-control\" id=\"customerName\" name=\"customerName\" aria-describedby=\"customerNameHelp\" placeholder=\"e.g. John Smith\" title=\"Enter your full name\" >");
            } else {
        ...
        sb.append("<span class=\"text-muted\">O. Kalu ::: CS472-WAP</span><span style=\"float:right;\" class=\"text-muted\">&copy May 2020</span>");
        sb.append("</div>");
        sb.append("</footer>");
        sb.append("</body>");
        sb.append("</html>");
